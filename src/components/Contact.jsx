...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send('service_hwdke2e', 'first_template',
      {
          from_name: form.name,
          to_name: "Isabel",
          from_email: form.email,
          to_email: "isabelmesina@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Thank you. I will get back to you as soon as possible. Gracias, me contactaré contigo lo antes posible");
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder='Let me know what do you want me to'
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
